...
const celebration = () => {
  return (
    <div className="relative bg-white w-full h-[665px] overflow-hidden text-left text-[14px] text-black font-work-sans">
      ...
      <div className="absolute top-[394px] left-[101px] w-[196px] h-[49px] text-center text-3xl">
        <b className="absolute top-[0px] left-[0px] tracking-[0.2px] leading-[32px] flex items-center justify-center w-[196px] h-[49px] text-[32px]">
          find Mickey!
        </b>
      </div>
